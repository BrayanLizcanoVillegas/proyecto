        ...
        <div class="container">
            <div class="contact-form">
                ...
                <div class="col-md-8 contact-grid">
                    <form action="#" method="post">
                        <input type="text" value="Nombre" onfocus="this.value='';"
                            onblur="if (this.value == '') {this.value ='Nombre';}">

                        <input type="text" value="Correo" onfocus="this.value='';"
                            onblur="if (this.value == '') {this.value ='Correo';}">
                        <input type="text" value="Asunto" onfocus="this.value='';"
                ...
                <div class="col-md-4 contact-in">
                    ...
                    <div class="address-more">
                        <h4>Direccion</h4>
                        <p>FUNDACION ESCUELA TECNOLOGICA</p>
                        <p>FERRE-FET</p>
                        <p>NO SE </p>
                    </div>
